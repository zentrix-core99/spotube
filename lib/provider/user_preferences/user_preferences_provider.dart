...
class UserPreferencesNotifier extends Notifier<PreferencesTableData> {
  ...
  Future<String> _getDefaultDownloadDirectory() async {
    ...
    // iOS sandboxes have no Downloads directory, so getDownloadsDirectory()
    // resolves to null there. Documents is the persistent location that
    // survives restarts and is exposed via Files (UIFileSharingEnabled).
    if (kIsIOS) {
      return join(
